...
class CommandSchedulerTest {
    ...
    @Test
    void testCallOnce() {
        CommandScheduler scheduler = CommandScheduler.parse("dcmd once 10 time set day");
    ...
    @Test
    void testCallRepeat() {
        CommandScheduler scheduler = CommandScheduler.parse("dcmd repeat 3 10 /time set night");
    ...
    void testCallInfinite() {
        CommandScheduler scheduler = CommandScheduler.parse("dcmd infinite 60 weather rain");
    ...
    @Test
    void testCallCancel() {
        CommandScheduler scheduler = CommandScheduler.parse("dcmd cancel 25");
